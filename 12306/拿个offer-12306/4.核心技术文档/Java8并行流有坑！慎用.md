...
那项目中业务使用的并行流真的会都并行处理么?

## 如何使用 ParallelStream

ParallelStream 在使用上与 Stream 无区别，本质返回的都是一个流，只不过底层处理时 **根据条件判断是并行或者是串行。**

![1672476576564-b5eea7b8-fc0f-44c2-a44a-2df02b6b7109.gif](./img/nQgD8KhBP7BV4ZLO/1672476576564-b5eea7b8-fc0f-44c2-a44a-2df02b6b7109-696714.gif)
...
**程序中使用的并行流，使用的都是 ForkJoinPool 中的静态变量 common。**继续看本节提出的问题，项目中使用了并行流的代码，真的能够达到并行么?
...
![1672476603734-33b4808e-7984-4d7d-b4c7-1ca722f09865.gif](./img/nQgD8KhBP7BV4ZLO/1672476603734-33b4808e-7984-4d7d-b4c7-1ca722f09865-405729.gif)
...
> 更新: 2023-08-24 13:29:31  
> 原文: <https://www.yuque.com/magestack/12306/hgq6dl5r5gfk2np8>