...
![image-20200921095428315.png](./img/c-zl7QGw1kg9EuQ6/1723976895729-59ba951f-02c5-404a-b0b9-7cfc90ef63ad-284424.png)

如果使用下面这段代码当作抢购优惠券的后台程序，我们一起看一下，可能存在什么样的问题。

![%E4%BC%98%E6%83%A0%E5%88%B8%E6%8A%A2%E8%B4%AD.png](./img/c-zl7QGw1kg9EuQ6/1723976895643-a7260a20-e72e-405a-aa8b-90ab1b767937-859244.png)
...
![synchronized.png](./img/c-zl7QGw1kg9EuQ6/1723976895230-7bf306d2-2f52-42cb-a558-ac2ce04127cb-263815.png)
...
![setIfAbsent.png](./img/c-zl7QGw1kg9EuQ6/1723976895619-9a9e71cd-3e86-4560-9b78-39e2875a70a2-877888.png)
...
![image-20201121112507681.png](./img/c-zl7QGw1kg9EuQ6/1723976895450-ab92b50f-98fa-4f6f-8a2a-eee9b26156f5-816124.png)
...
![expire.png](./img/c-zl7QGw1kg9EuQ6/1723976895401-189a70e3-d2db-4b0d-90dd-dd4987bdf910-052817.png)
...
![jedis_set.png](./img/c-zl7QGw1kg9EuQ6/1723976895464-841a0a87-7382-4c13-828c-c64ab4213e44-620613.png)
...
3.  然而此时**线程一执行完业务**后，开始执行释放锁的流程，然后**顺手就把线程二获取的锁释放**了。 
...
![verify_value.png](./img/c-zl7QGw1kg9EuQ6/1723976895428-9ba02187-5b04-4e94-880a-f1af12885ab5-570013.png)



这一版的代码相当于我们添加锁标志位时，同时**为每个客户端设置了 uuid 作为锁标志位的 val**，解锁时需要判断锁的 val 是否和自己客户端的相同，辨别成功才会释放锁。



但是上述代码执行业务逻辑如果抛出异常，锁只能等待过期时间，我们可以将解锁操作放到 finally 块。

![finally_del.png](./img/c-zl7QGw1kg9EuQ6/1723976895162-b59eb65b-6c00-45a4-b04b-b663236e9841-780238.png)
...
![lua_atom.png](./img/c-zl7QGw1kg9EuQ6/1723976895271-51a2bc11-18f6-44ab-85e1-64f53d536645-308683.png)
